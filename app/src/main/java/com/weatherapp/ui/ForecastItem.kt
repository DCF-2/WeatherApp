...
@Composable
fun ForecastItem(forecast: Forecast, onClick: (Forecast) -> Unit, modifier: Modifier = Modifier.Companion) {
    ...
    Row (modifier =
        ...
        Column {
            ...
            Row {
                Text(modifier = Modifier.Companion, text = forecast.date, fontSize = 20.sp)
                Spacer (modifier =
